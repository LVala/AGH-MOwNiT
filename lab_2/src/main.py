...
from utils import gen_points_chebyshev, gen_points_equally, newton_intpol, lagrange_intpol, get_accuracy_sqr
...
for num_of_points in range(1,51,2):
    ...
    print(f"{num_of_points} points: NEWTON CHEB = {get_accuracy_sqr(f, newt_cheb, left_end, right_end, 1000):.8f}, EQL = {get_accuracy_sqr(f, newt_eql, left_end, right_end, 1000):.2f} \
