...
def plot_from_func(funcs: list[Callable[[float], float]], names: list[str], left_end: int, right_end: int, num_of_points: int, knots) -> None:
    ...
    plt.xlabel("x")
    plt.ylabel("f(x)")
    ax.plot(knots[0][0], knots[0][1], linestyle="None", marker="o", markerfacecolor="black")
    ax.plot(knots[1][0], knots[1][1], linestyle="None", marker="o", markerfacecolor="orange")
